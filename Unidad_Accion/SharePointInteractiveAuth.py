...
class SharePointInteractiveAuth:
    def __init__(self):
        ...
        self.client_id = "04b07795-8ddb-461a-bbee-02f9e1bf7b46"  # Microsoft Graph PowerShell
        self.tenant_id = "common"  # Usar 'common' para multi-tenant
        self.scope = ["https://graph.microsoft.com/.default"]
        self.authority = f"https://login.microsoftonline.com/{self.tenant_id}"
        
        # URLs de SharePoint
        self.sharepoint_url = os.getenv('SHAREPOINT_URL', 'https://unitechn.sharepoint.com')
        self.site_url = os.getenv('SHAREPOINT_SITE_URL', 'https://unitechn.sharepoint.com/sites/TutoriasUNITEC2')
    ...
    def authenticate_interactive(self):
        ...
        try:
            ...
            if "access_token" in result:
                ...
                print(f"Error en autenticación: {result.get('error_description', 'Error desconocido')}")
                return False
    ...
    def get_list_items(self, list_name, fields=None):
        ...
        try:
            ...
            print(f"Se obtuvieron {len(processed_items)} elementos de la lista '{list_name}'")
    ...
    def update_list_item(self, list_name, item_id, item_data):
        ...
        try:
            ...
            print(f"Elemento {item_id} actualizado exitosamente en la lista '{list_name}'")
            return response.json()
            
        except Exception as e:
            print(f"Error actualizando elemento {item_id} en la lista '{list_name}': {str(e)}")
            return None
